...
- [x] [Feature 1 - completed date]
  ...
  - Impact: [How it helps users/project]
...
|--------|---------|--------|--------|
| API Response Time (p95) | [X]ms | <200ms | 🟢/🟡/🔴 |
| Page Load Time (p95) | [X]s | <2s | 🟢/🟡/🔴 |
| Time to Interactive | [X]s | <3s | 🟢/🟡/🔴 |
| Lighthouse Score | [X] | >90 | 🟢/🟡/🔴 |

### Code Quality
- **Linter Errors:** [Number]
- **Type Errors:** [Number]
...
**Carried Over:**
- [ ] [Story/Task 3] - [Reason for carry over]
...
|------------|--------|--------|-----|
| [Service/Team 1] | [Status] | [Impact] | [ETA] |
| [Service/Team 2] | [Status] | [Impact] | [ETA] |
...
- **Allocated:** [X] story points / [Y] hours
- **Available:** [X] story points / [Y] hours
...
**Note:** Update this file after EVERY task completion. Keep it current to reflect true project status.
